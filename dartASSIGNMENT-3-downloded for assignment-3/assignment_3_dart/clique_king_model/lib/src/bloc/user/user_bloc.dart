...
final class UserRegisterProgress extends UserState {
  @override
  List<Object?> get props => [];
}
...
//---------------------------------
//dui dhoroner class ase event r emit , event jave emit ashbe , amake registrationer emits gula banate hbe
        ...
        switch (event) {
          ...
          case UserRegister():
            ...
            if(event.email==null){
              ...
              User user =  await _authRepo.signUp(event.name,event.email,event.password);
          ...
          //_userRepo.createUser(event.name,event.id);
